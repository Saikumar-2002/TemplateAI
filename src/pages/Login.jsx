    ...
    <div className="min-h-[80vh] flex items-center justify-center pt-20 px-4">
      <div className="w-full max-w-md p-8 glass rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="text-gray-400 mt-2">Log in to your TemplateAI account</p>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-4 mb-6">
          ...
          <div className="text-xs text-gray-500 uppercase font-bold tracking-wider">or sign in with email</div>
          <div className="h-px bg-white/10 flex-1"></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          <button 
            disabled={loading}
            type="submit" 
            className="w-full py-4 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-500 hover:from-violet-500 hover:to-indigo-400 text-white font-bold transition shadow-lg disabled:opacity-50"
          >
        ...
        <div className="mt-8 text-center text-gray-400 text-sm relative z-10">
          Don't have an account? <Link to="/signup" className="text-violet-400 hover:text-violet-300 font-semibold transition">Sign Up</Link>
        </div>
      </div>
    </div>
  );
